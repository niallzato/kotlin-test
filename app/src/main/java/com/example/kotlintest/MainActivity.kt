...
import com.example.kotlintest.plugins.AndroidRecordScreenPlugin
import com.example.kotlintest.plugins.OddDay
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var analytics = Analytics("HKOAEXpjmwew7I9kNXZJQan3KEHo0Bm8", applicationContext) {
